 ...
 *
 *
 * Operation: 'SecurityIdentity_GetSecurityEntryByName'
 * Endpoint Path: '/securityidentities/{webId}/securityentries/{name}'
 * Method: 'get'
 *
 */
...
function processAction(msg, cfg) {
    ...
    let callParams = {
        ...
        pathName: '/securityidentities/{webId}/securityentries/{name}',
        method: 'get',
